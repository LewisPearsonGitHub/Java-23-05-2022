...
public class results {
	...
	public static void main(String[] args) {
		...
		results.method2(percentage, total, physics, biology, chemistry, classesfailed);
	}
	...
	public static void method2(float percentage, int total, int physics, int chemistry, int biology, int classesfailed) {
